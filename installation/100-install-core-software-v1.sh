...
#sudo pacman -S --noconfirm --needed galculator geary git glances gnome-disk-utility
...
sudo pacman -S --noconfirm --needed variety vlc-nightly vnstat wget unclutter
